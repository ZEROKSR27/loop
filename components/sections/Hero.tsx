...
const Hero = () => {
    return (
        <section className="relative" id="home">
            <div
                aria-hidden="true"
                className="absolute inset-0 grid grid-cols-2 -space-x-20 sm:-space-x-52 opacity-50 "
            >
            ...
            <div>
                <div className="relative pt-36">
                    <div className="lg:w-2/3 text-center mx-auto pb-6">
                        ...
                        <p className="mt-8 text-gray-700 selection:bg-green-200 p-4  ">
                        ...
                        <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6 px-4">
                            <Link
                                href="/dashboard"
